...
const products = [
    ...
    { id: 3, name: "Słuchawki bezprewodowe", price: 100, description: "9 na 10 programisów je poleca"},
];
...
app.post("/api/payments", (req, res) => {
    ...
    if (amount && amount >= 0) {
	res.status(200).json({ success: true, message: "Płatność zrealizowana pomyślnie" });
    } else {
